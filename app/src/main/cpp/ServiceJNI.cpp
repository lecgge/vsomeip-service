...
void on_message(const std::shared_ptr<vsomeip::message> &_message) {
    ...
    //获取指向message的变量
    jfieldID jf = env->GetFieldID(clz, "mNativePtr","J");
    env->SetLongField(g_ctx->app_object, jf, (jlong)_message.get());
    //获取要回调的方法
...
Java_com_example_vsomeip_VSomeIPService_create(JNIEnv *env, jobject thiz, jstring app_name,
                                               jobject service) {
    // 初始化context
...
Java_com_example_vsomeip_VSomeIPService_init(JNIEnv *env, jobject thiz) {
    bool ret = g_ctx->app->init();
    return ret;
}
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vsomeip_VSomeIPService_offer_1service(JNIEnv *env, jobject thiz, jint service_id,
                                                       jint instance_id) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vsomeip_VSomeIPService_offer_1service1(JNIEnv *env, jobject thiz, jint service_id,
                                                        jint instance_id,jint methodId) {
    g_ctx->app->register_message_handler(service_id, instance_id, methodId, on_message);
    g_ctx->app->offer_service(service_id, instance_id);
}
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vsomeip_VSomeIPService_offer_1event(JNIEnv *env, jobject thiz, jint service_id,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vsomeip_VSomeIPService_offer_1field(JNIEnv *env, jobject thiz, jint service_id,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vsomeip_VSomeIPService_stop_1offer_1event(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vsomeip_VSomeIPService_stop_1offer_1field(JNIEnv *env, jobject thiz,
                                                           jint service_id, jint instance_id,
                                                           jint field_id) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vsomeip_VSomeIPService_start(JNIEnv *env, jobject thiz) {
    g_ctx->app->start();
}
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vsomeip_VSomeIPService_stop(JNIEnv *env, jobject thiz) {
    g_ctx->app->stop();
}
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vsomeip_VSomeIPService_notify(JNIEnv *env, jobject thiz, jint service_id,
                                               jint instance_id, jint event_id,
                                               jbyteArray payload, jint client_id) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vsomeip_VSomeIPService_send_1response(JNIEnv *env, jobject thiz, jint service_id,
                                                       jint instance_id, jint method_id,
                                                       jbyteArray payload,jlong nativePtr) {
    // TODO: 从等待响应的请求池中取出请求消息
    // 构建响应消息
    std::shared_ptr<vsomeip::message> request((vsomeip::message*)nativePtr);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vsomeip_VSomeIPService_close(JNIEnv *env, jobject thiz) {
    // 释放资源
